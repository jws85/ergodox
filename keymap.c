...
#define V_MOUSE LT(LAYER_MOUSE, KC_V)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [LAYER_BASE] = LAYOUT_ergodox_pretty(
    ...
    KC_GRV,  KC_A,    KC_S,    KC_D,    F_CURSE, KC_G,                         KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    V_MOUSE, KC_B,    KC_LBRC,    KC_RBRC, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
  ...
  [LAYER_FUNC] = LAYOUT_ergodox_pretty(
    ...
    _______, _______, _______, _______, XXXXXXX, KC_F11,  KC_F11,     KC_F12,  KC_F12,  XXXXXXX, _______, _______, _______, _______,
  ...
  [LAYER_CURSR] = LAYOUT_ergodox_pretty(
    ...
    _______, _______, _______, _______, MO_MEDA, _______, _______,    BSPC_WD, KC_HOME, KC_PGDN, KC_PGUP, KC_END,  _______, _______,
  ...
  [LAYER_MOUSE] = LAYOUT_ergodox_pretty(
    ...
    _______, _______, _______, _______, MO_MEDA, _______,                      KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______,
